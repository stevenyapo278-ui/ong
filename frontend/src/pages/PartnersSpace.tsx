...
import { Globe, Building, Target, Handshake, Mail, ArrowRight, BarChart3, Briefcase, Zap } from 'lucide-react';
        ...
        <div className="min-h-screen bg-white font-sans overflow-hidden">
            ...
            <section className="relative h-[65vh] md:h-[75vh] flex items-center overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6 w-full text-white">
                    ...
                    >
                        ...
                        <button className="px-10 py-5 bg-white text-slate-900 rounded-2xl font-black text-xs uppercase tracking-[0.2em] shadow-2xl hover:bg-secondary hover:text-white transition-all transform hover:-translate-y-1">
                            Devenir Partenaire
                        </button>
                    </motion.div>
                </div>
            ...
            <section className="py-24 bg-white relative">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-24 space-y-6">
                        <h2 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tight">Nos modes de <br className="md:hidden" /><span className="text-secondary italic">collaboration</span></h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            ...
                            <motion.div 
                                ...
                                className="p-8 bg-slate-50 rounded-[40px] border border-slate-100 group hover:bg-slate-900 transition-all duration-500"
                            >
                                ...
                                <h3 className="text-lg font-black text-slate-900 group-hover:text-white mb-4 italic leading-tight">{mode.title}</h3>
                                <p className="text-slate-500 text-sm font-medium group-hover:text-white/60 leading-relaxed">{mode.desc}</p>
                            </motion.div>
                        ))}
                    </div>
                </div>
            ...
            <section className="py-32 bg-secondary/10 overflow-hidden relative">
                <div className="max-w-7xl mx-auto px-6 flex flex-col items-center text-center space-y-12 relative z-10">
                    <div className="w-24 h-24 bg-white rounded-[40px] flex items-center justify-center shadow-xl shadow-secondary/20">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6">
                        ...
                        <button className="px-12 py-5 bg-slate-900 text-white rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-secondary transition-all flex items-center gap-3">
