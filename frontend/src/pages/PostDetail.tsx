...
const PostDetail = () => {
  ...
  const sanitizedContent = useMemo(() => {
    ...
    return DOMPurify.sanitize(post.content, {
      ALLOWED_TAGS: ['p', 'div', 'span', 'strong', 'em', 'ul', 'ol', 'li', 'h2', 'h3', 'blockquote', 'a', 'img', 'video', 'source', 'iframe'],
      ALLOWED_ATTR: ['href', 'target', 'rel', 'src', 'alt', 'title', 'controls', 'allow', 'allowfullscreen', 'frameborder', 'style', 'data-size', 'data-type', 'data-name', 'data-cols', 'class'],
    });
  }, [post?.content]);
